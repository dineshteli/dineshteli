...
function findcost(){
	...
	if ((document.getElementById("domainext").value=="- select -") && (document.getElementById("domainduration").value=="- select -") && (document.getElementById("hostingduration").value=="- select -"))
	{
		// when domain extension, duration and hosting duration are empty
		alert("Error\nPlease select the options");
	}

	else if ((document.getElementById("domainext").value!=="- select -") && (document.getElementById("domainduration").value=="- select -")) {
		// when domain duration is empty
		alert("Error\nPlease select domain duration");
	}

	else if ((document.getElementById("domainext").value=="- select -") && (document.getElementById("domainduration").value!=="- select -")) {
		// when domain extension is empty
		alert("Error\nPlease select domain extension");
	}

	else if((document.getElementById("domainext").value!=="- select -") && (document.getElementById("domainduration").value!=="- select -") && (document.getElementById("hostingduration").value=="- select -"))
	{
	...
	else if((document.getElementById("domainext").value=="- select -") && (document.getElementById("domainduration").value=="- select -") && (document.getElementById("hostingduration").value!=="- select -"))
	{
		...
		confirm("error in cost checking");
	}
