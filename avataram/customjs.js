...
//function code for finding website cost
...
function findcost() {
	...
	function showHostingCost() {
		var host_cost = [40, 30, 20];//12months,24months,48months
		if (document.getElementById("hostingduration").value == "1 year") {
			document.getElementById("sethostingcost").innerHTML = host_cost[0] * 12;
			document.getElementById("hostingRenewalCost").innerHTML = host_cost[0] * 12;
			hostingCost = host_cost[0] * 12;
		}
		else if (document.getElementById("hostingduration").value == "2 years") {
			document.getElementById("sethostingcost").innerHTML = host_cost[1] * 24;
			document.getElementById("hostingRenewalCost").innerHTML = host_cost[1] * 24;
			hostingCost = host_cost[1] * 24;
		}
		else if (document.getElementById("hostingduration").value == "4 years") {
			document.getElementById("sethostingcost").innerHTML = host_cost[2] * 48;
			document.getElementById("hostingRenewalCost").innerHTML = host_cost[2] * 48;
			hostingCost = host_cost[2] * 48;
		}
		else {
